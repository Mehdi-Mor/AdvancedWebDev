  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Optionally redirect to thanks page
  ...
  return (
    <form onSubmit={handleSubmit} className="mx-auto max-w-5xl px-4 py-9 sm:px-6">
      <section className="mx-auto max-w-5xl px-6 py-9 text-center">
        ...
        {successMessage && (
          <div className="mx-auto mt-6 max-w-3xl rounded-3xl border border-green-300 bg-green-50 px-6 py-5 text-center shadow-sm">
            <p className="text-2xl font-semibold text-green-800">{successMessage}</p>
          </div>
        )}
      </section>
    </form>
